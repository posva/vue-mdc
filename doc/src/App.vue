    ...
    <div class="mdl-layout
      ...
      <div class="mdl-layout__drawer" ref="drawer">
        <template v-for="menu in items">
          <NavEntry :menu="menu" />
          <NavItem v-for="item in menu.items" :item="item" />
        </template>
        <span class="mdl-layout-title mdl-layout-title--icon">
          <i class="material-icons">link</i>
          Links</span>
        <nav class="mdl-navigation">
          <a class="mdl-navigation__link
                    mdl-navigation__link--icon"
             href="https://github.com/posva/vue-mdl"
             target="_blank">Github</a>
          <a class="mdl-navigation__link
                    mdl-navigation__link--icon"
             href="https://www.npmjs.com/package/vue-mdl"
             target="_blank">NPM</a></nav>
      </div>
